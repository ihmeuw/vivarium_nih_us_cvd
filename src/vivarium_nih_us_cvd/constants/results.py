...
YLDS_COLUMN_TEMPLATE = (
    "MEASURE_ylds_due_to_{CAUSE_OF_DISABILITY}_year_{YEAR}_sex_{SEX}_age_{AGE_GROUP}"
)
STATE_PERSON_TIME_COLUMN_TEMPLATE = (
    "MEASURE_{STATE}_person_time_year_AGE_GROUP_{AGE_GROUP}_CURRENT_YEAR_{YEAR}_SEX_{SEX}"
)
TRANSITION_COUNT_COLUMN_TEMPLATE = (
    "MEASURE_{TRANSITION}_event_count_year_AGE_GROUP_{AGE_GROUP}_CURRENT_YEAR_{YEAR}_SEX_{SEX}"
)
...
SBP_MEDICATION_PERSON_TIME_TEMPLATE = "MEASURE_sbp_medication_{SBP_MEDICATION}_person_time_AGE_GROUP_{AGE_GROUP}_CURRENT_YEAR_{YEAR}_medication_adherence_{MEDICATION_ADHERENCE}_SEX_{SEX}"
LDLC_MEDICATION_PERSON_TIME_TEMPLATE = "MEASURE_ldlc_medication_{LDLC_MEDICATION}_person_time_AGE_GROUP_{AGE_GROUP}_CURRENT_YEAR_{YEAR}_medication_adherence_{MEDICATION_ADHERENCE}_SEX_{SEX}"
