...
HEART_FAILURE_FROM_ISCHEMIC_HEART_DISEASE_STATE_NAME = "heart_failure_from_ischemic_heart_disease"
ACUTE_MYOCARDIAL_INFARCTION_AND_HEART_FAILURE_STATE_NAME = "acute_myocardial_infarction_and_heart_failure"
...
ISCHEMIC_HEART_DISEASE_AND_HEART_FAILURE_MODEL_TRANSITIONS = (
    ...
    TransitionString(
        f"{ACUTE_MYOCARDIAL_INFARCTION_STATE_NAME}_TO_{HEART_FAILURE_FROM_ISCHEMIC_HEART_DISEASE_STATE_NAME}"
    ),
    TransitionString(
    ...
    TransitionString(
        f"{HEART_FAILURE_FROM_ISCHEMIC_HEART_DISEASE_STATE_NAME}_TO_{ACUTE_MYOCARDIAL_INFARCTION_STATE_NAME}"
    ),
)
